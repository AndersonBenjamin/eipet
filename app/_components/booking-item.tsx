            ...
            <SheetContent className="px-0">
                ...
                <div className="px-5">
                    <div className="relative h-[180px] w-full mt-6">
                        <Image src="/map.jpg" fill style={{ objectFit: "contain", }} alt={booking.petshop.name} />
                            ...
                            <Card>
                                <CardContent className="p-3 flex gap-2">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="text-xs overflow-hidden text-nowrap text-ellipsis">{booking.petshop.address}</h3>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                    ...
                    <Card>
                        <CardContent className="p-3 gap-3 flex flex-col">
                            ...
                            <div className="flex justify-between">
                                ...
                                <h4 className="text-sm">{booking.petshop.name}
                                </h4>
                            </div>
                        </CardContent>
                    </Card>
